...
export default function DashboardLayout({
  ...
  return (
    /*
      UserProvider يلف كل الداشبورد: بيجيب بيانات المستخدم الحالي والصلاحيات
      مرة وحدة، وكل الكومبوننتات (Sidebar, Navbar, ...) بتقرأ منه
      بدل ما كل واحد يعمل استعلام لحاله.
    */
    <UserProvider>
